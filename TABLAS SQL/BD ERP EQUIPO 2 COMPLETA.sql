...
(
idCliente,nombre,razonSocial,limiteCredito,rfc,telefono,email,tipo,estatus
)
...
(
idDireccion,calle,numero,colonia,codigoPostal,tipo,idCliente,idCiudad,estatus
)
