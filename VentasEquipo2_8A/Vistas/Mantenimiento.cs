...
namespace Vistas
{
    public partial class Mantenimiento : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txt_idMantenimiento.Text) || string.IsNullOrEmpty(txt_fechaInicio.Text) || string.IsNullOrEmpty(txt_fechaFin.Text) || string.IsNullOrEmpty(txt_taller.Text) || string.IsNullOrEmpty(txt_costo.Text) || string.IsNullOrEmpty(txt_comentarios.Text) || string.IsNullOrEmpty(txt_tipo.Text))
            {
