...
namespace Datos
{
    ...
    public class ConexionSQL
    {
        ...
        public int consultalogin(string Usuario, string Contrasena)
        {
            int count;
            con.Open();
            string Query = "Select Count(*) From Empleados where email = '" + Usuario + "'" +
                "and pass = '" + Contrasena + "'";
        ...
        public int modificarDireccionCliente(string idDireccion, string calle, string numero, string colonia, string codigoPostal, string tipo, string idCliente, string idCiudad)
        {
            int flag = 0;
            con.Open();
            string query = "Update SalesDireccionesCliente set calle='" + calle + "', numero='" + numero + "', colonia='" + colonia + "', codigoPostal='" + codigoPostal + "', tipo='" + tipo + "', idCliente='" + idCliente + "', idCiudad='" + idCiudad + "' where idDireccion ='" + idDireccion + "'";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        //***********************************TABLA SalesVentas **************************************************
        //METODO PARA AGREGAR NUEVO SalesVentas
        public int insertarSalesVentasDG(string fecha, string cantidad, string subtotal, string iva, string total, string comentarios, string estatus, string idCliente, string idSucursal, string idEmpleado, string tipo)
        {
            int flag = 0;
            con.Open();
            string query = "insert into SalesVentas values('" + fecha + "', '" + cantidad + "', '" + subtotal + "', '" + iva + "', '" + total + "', '" + comentarios + "', '" + estatus + "', '" + idCliente + "', '" + idSucursal + "', '" + idEmpleado + "', '" + tipo + "')";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        //METODO PARA MODIFICAR SalesVentas EN LA BD
        public int modificarSalesVentasDG(string idVenta,string subtotal, string iva, string total)
        {
            int flag = 0;
            con.Open();
            string query = "Update SalesVentas set subtotal ='" + subtotal + "', iva  ='" + iva + "', total   ='" + total + "'where idVenta ='" + idVenta + "'";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        //METODO PARA MODIFICAR SalesVentas TIPO DE VENTA(CONTADO O CREDITO) EN LA BD
        public int modificarSalesVentasCreditoDG(string idVenta, string Tipo)
        {
            int flag = 0;
            con.Open();
            string query = "Update SalesVentas set Tipo ='" + Tipo + "'where idVenta ='" + idVenta + "'";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        public int modificarSalesVentaDetalleDG(string idVentaDetalle, string precioVenta, string cantidad, string subtotal, string idVenta, string idPresentacion, string estatus)
        {
            int flag = 0;
            con.Open();
            string query = "Update SalesVentas set precioVenta ='" + precioVenta + "', cantidad   ='" + cantidad + "', subtotal   ='" + subtotal + "', idVenta   ='" + idVenta + "', idPresentacion   ='" + idPresentacion + "', estatus   ='" + estatus + "'where idVentaDetalle ='" + idVentaDetalle + "'";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        public int modificarSalesVentaDetalleEditBotonDG(string idVentaDetalle,string cantidad, string subtotal,string idPresentacion)
        {
            int flag = 0;
            con.Open();
            string query = "Update SalesVentaDetalle set cantidad ='" + cantidad + "', subtotal   ='" + subtotal + "', idPresentacion   ='" + idPresentacion + "'where idVentaDetalle ='" + idVentaDetalle + "'";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        //---eliminacion de idVentadetalle de la tabla SalesVentasDetalle
        public int EliminacionIdVentadetalleDG(string idVentaDetalle)
        {
            int flag = 0;
            con.Open();

            string query = "Delete from SalesVentaDetalle where idVentaDetalle  = '" + idVentaDetalle + "'";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        //--eliminar la idventa 
        public int EliminacionIdVentaDG(string idVenta)
        {
            int flag = 0;
            con.Open();

            string query = "Delete from SalesVentas where idVenta  = '" + idVenta + "'";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        //---eliminacion de idEnvio en tabla de Envio
        public int EliminacionidEnvioDG(string idEnvio)
        {
            int flag = 0;
            con.Open();

            string query = "Delete from SalesEnvios where idEnvio  = '" + idEnvio + "'";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        //---eliminacion de idventa en tabla de EnviosDetalle
        public int EliminacionidventaSalesEnvioDetalleDG(string idVenta)
        {
            int flag = 0;
            con.Open();

            string query = "Delete from SalesDetallesEnvio where idVenta  = '" + idVenta + "'";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        //METODO PARA MODIFICAR LAS existencia de las sucursales 
        public int modificarexistenciaSucursalDG(string idExistenciaSuc, string cantidad)
        {
            int flag = 0;
            con.Open();
            string query = "Update existenciaSucursales set cantidad ='" + cantidad + "'where idExistenciaSuc ='" + idExistenciaSuc + "'";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        public int insertarSalesCobrosDG(string fecha, string importe, string idVenta,string idformaPago, string estatus)
        {
            int flag = 0;
            con.Open();
            string query = "insert into SalesCobros values('" + fecha + "', '" + importe + "', '" + idVenta + "','" + idformaPago + "', '" + estatus + "')";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        public int modificarSalesCobrosSalesVentaEstatusTextDG(string idVenta, string cantPagada,string estatus)
        {
            int flag = 0;
            con.Open();
            string query ="Update SalesVentas set cantPagada ='" + cantPagada + "', estatus ='" + estatus + "'where idVenta ='" + idVenta + "'";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        public int insertarSalesDetallesEnvioDG(string idEnvio, string idVenta, string idDireccion, string fechaEntregaPlaneada, string fechaRecepcion, string peso, string estatus, string idContacto)
        {
            int flag = 0;
            con.Open();
            string query = "insert into SalesDetallesEnvio values('" + idEnvio + "','" + idVenta + "', '" + idDireccion + "', '" + fechaEntregaPlaneada + "', '" + fechaRecepcion + "','" + peso + "', '" + estatus + "', '" + idContacto + "')";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        //***********************************TABLA SalesEnvio **************************************************
        //METODO PARA INSERTAR LAS SalesEnvios EN LA BD
        public int insertarSalesEnviosDG(string fechaInicio, string fechaFin, string idUnidadTransporte, string pesoTotalVenta, string estatus)
        {
            int flag = 0;
            con.Open();
            string query = "insert into SalesEnvios values('" + fechaInicio + "', '" + fechaFin + "', '" + idUnidadTransporte + "','" + pesoTotalVenta + "', '" + estatus + "')";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        public int modificarSalesEnviosTablaSalesEnvioDG(string idEnvio,string pesoTotalVenta, string estatus)
        {
            int flag = 0;
            con.Open();
            string query = "Update SalesEnvios set pesoTotalVenta ='" + pesoTotalVenta + "',estatus ='" + estatus + "'where idEnvio ='" + idEnvio + "'";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        //METODO PARA INSERTAR LAS SalesTripulacion EN LA BD
        public int insertarSalesTripulacionDG(string idEmpleado, string idEnvio, string rol,string estatus)
        {
            int flag = 0;
            con.Open();
            string query = "insert into SalesTripulacion values('" + idEmpleado + "','" + idEnvio + "','" + rol + "', '" + estatus + "')";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        //METODO PARA MODIFICAR LAS SalesTripulacion EN LA BD
        public int modificarSalesTripulacionDG(string idEmpleado, string idEnvio, string rol, string estatus)
        {
            int flag = 0;
            con.Open();
        ...
        //***********************************TABLA SalesOfertaAsociacion**************************************************
        //METODO PARA INSERTAR LAS SalesOfertaAsociacion EN LA BD
        public int insertarSalesOfertAsocoacionDG(string idAsosiacion, string idOferta, string estatus)
        {
            int flag = 0;
            con.Open();
            string query = "insert into SalesOfertasAsociacion values('" + idAsosiacion + "','" + idOferta + "', '" + estatus + "')";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        //METODO PARA MODIFICAR LAS SalesOfertaAsociacion EN LA BD
        public int modificarSalesOfertAsocoacionDG(string idAsosiacion, string idOferta, string estatus)
        {
            int flag = 0;
            con.Open();
            string query = "Update SalesOfertasAsociacion set idOferta ='" + idOferta + "', estatus ='" + estatus + "'where idAsosiacion ='" + idAsosiacion + "'";
            SqlCommand cmd = new SqlCommand(query, con);
            flag = cmd.ExecuteNonQuery();
            con.Close();
            return flag;
        ...
        ////////////////PAGINACION DE SalesEnvios ////////////////////
        public DataSet Lista_SalesTripulacion(Class_Entidad obje)
        {
            SqlCommand cmd = new SqlCommand("sp_listar_SalesTripulacion", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@tab_inicio", obje.varDatoInicio);
            cmd.Parameters.AddWithValue("@tab_final", obje.varDatoFinal);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
        ...
        ////////////////PAGINACION DE SalesOfertasAsociacion ////////////////////
        public DataSet Lista_SalesOfertasAsociacion(Class_Entidad obje)
        {
            SqlCommand cmd = new SqlCommand("sp_listar_SalesOfertasAsociacion", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@tab_inicio", obje.varDatoInicio);
            cmd.Parameters.AddWithValue("@tab_final", obje.varDatoFinal);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
