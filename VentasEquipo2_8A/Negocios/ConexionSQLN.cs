...
namespace Negocios
{
    public class ConexionSQLN
    {
        ...
        public int InsertarSalesVentasDT(string fecha, string cantPagada,string idProducto, string subtotal, string iva, string total, string comentarios, string estatus, string idCliente, string idSucursal, string idEmpleado, string tipo)
        {

            return cn.insertarSalesVentasDG(fecha, cantPagada, idProducto, subtotal, iva, total, comentarios, estatus, idCliente, idSucursal, idEmpleado, tipo);

        }

        public int ModificarSalesVentasDT(string idVenta, string fecha, string cantPagada, string idProducto, string subtotal, string iva, string total, string comentarios, string estatus, string idCliente, string idSucursal, string idEmpleado, string tipo)
        {

            return cn.modificarSalesVentasDG(idVenta,fecha, cantPagada, idProducto, subtotal, iva, total, comentarios, estatus, idCliente, idSucursal, idEmpleado, tipo);
        ...
        public int InsertarSalesCobrosDT(string fecha, string importe, string idVenta, string estatus)
        {

            return cn.insertarSalesCobrosDG(fecha, importe, idVenta, estatus);

        }

        public int ModificarSalesCobrosDT(string idCobro, string fecha, string importe, string idVenta, string estatus)
        {

            return cn.modificarSalesCobrosDG(idCobro, fecha, importe, idVenta, estatus);
        ...
        public int InsertarSalesDetallesEnvioDT(string idVenta, string idDireccion, string fechaEntregaPlaneada, string peso, string estatus, string idContacto)
        {

            return cn.insertarSalesDetallesEnvioDG(idVenta, idDireccion, fechaEntregaPlaneada, peso, estatus, idContacto);

        }

        public int ModificarSalesDetallesEnvioDT(string idEnvio, string idVenta, string idDireccion, string fechaEntregaPlaneada, string peso, string estatus, string idContacto)
        {

            return cn.modificarSalesDetallesEnvioDG(idEnvio, idVenta, idDireccion, fechaEntregaPlaneada, peso, estatus, idContacto);
        ...
        public int InsertarSalesEnviosDT(string fechaInicio, string fechaFin, string idUnidadTransporte, string pesoTotal, string estatus)
        {

            return cn.insertarSalesEnviosDG(fechaInicio, fechaFin, idUnidadTransporte, pesoTotal, estatus);

        }

        public int ModificarSalesEnviosDT(string idEnvio, string fechaInicio, string fechaFin, string idUnidadTransporte, string pesoTotal, string estatus)
        {

            return cn.modificarSalesEnviosDG(idEnvio, fechaInicio, fechaFin, idUnidadTransporte, pesoTotal, estatus);
